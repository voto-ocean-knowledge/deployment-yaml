...
expected_units = {'AD2CP_HEADING': 'degrees',
                  ...
                  'LEGATO4_CONDUCTIVITY': 'mS cm-1',
                  'LEGATO_PRESSURE': 'dbar',
                  'LEGATO4_PRESSURE': 'dbar',
                  'LEGATO_SALINITY': 'PSU',
                  'LEGATO4_SALINITY': 'PSU',
                  'LEGATO_TEMPERATURE': 'Celsius',
                  'LEGATO4_TEMPERATURE': 'Celsius',
                  ...
                  'TRIDENTE_FDOM': 'ppb',
                  'TRIDENTE_PHYCOCYANIN': 'mg m-3',
                  'TRIDENTE_BACKSCATTER': 'm-1 sr-1',
                  'LEGATO_TRIDENTE_BACKSCATTER':'m-1 sr-1',
                  'LinCmd': 'cm',
                  'LinPos': 'cm',
